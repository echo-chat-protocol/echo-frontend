...
gitMove("src/components/EchoChatWidget/EchoChatWidget.jsx", "src/features/landing/EchoChatWidget.jsx");
...
gitMove("src/components/FooterComponents/Documentation.jsx", "src/pages/docs/DocumentationFooter.jsx"); 

      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-[#b9b9c4] leading-relaxed">
            Type anything below. Watch every byte get XOR-ed with a derived
            keystream in real time. A toy demo of what real{" "}
            <span className="font-mono text-[#e9d5ff]">XChaCha20-Poly1305</span>{" "}
        ...
        <p className="mt-6 text-center text-[11px] text-[#7a7a8a]">
          Demo only. Real ECHO uses XChaCha20-Poly1305 with per-message nonces
          and authenticated encryption. No XOR, no shortcuts.
        </p>
      </div>
    </section>
  );

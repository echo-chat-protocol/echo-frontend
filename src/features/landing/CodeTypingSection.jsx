      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-5">
          ...
          <p className="mt-5 text-[#b9b9c4] leading-relaxed">
            Drop the ECHO SDK into your stack and ship hardened messaging,
            video, file sharing or telemetry. TypeScript, Rust, Swift and
            Kotlin — all sharing a single audited cryptographic core.
          </p>
        ...
        <div className="lg:col-span-7">
          <div className="echo-code-window">
            <header>
            ...
            <pre className="font-mono text-[13px] sm:text-[14px] leading-[1.65] p-5 sm:p-6 text-[#e9e9ef] whitespace-pre-wrap">
              {lines.map((line, i) => (
                <div key={i}>
                  <Highlight line={line} />
                </div>
...
function Highlight({ line }) {
  ...
  // Tokenise minimal: keywords, strings, calls

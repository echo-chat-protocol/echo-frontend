...
export function ThemeProvider({ children }) {
  ...
  const [wallpaper, setWallpaper] = useState(() => localStorage.getItem("echo:wallpaper") || "constellation");
  ...
  const value = useMemo(
    () => ({ accent, wallpaper, setAccent, setWallpaper, applyTheme, currentThemeId, accents: ACCENTS, wallpapers: WALLPAPERS, themes: THEMES }),

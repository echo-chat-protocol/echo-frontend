...
// Gecko/lizard mascot for the "Gecho" console (Twemoji artwork, flattened to a
// single fill). All original green/eye colors are dropped in favor of
// currentColor so it inherits text color like the lucide icons it sits next to
// (keeps the violet tint + active-ring on the toggle button).
export default function GeckoIcon({ size = 18, className = '' }) {
  return (
    <svg
      width={size}
      height={size}
